...
m1 = Button(frame_main_meal, width=200, bg='#022841', font=('Tajawal', 11), fg="white", bd=0, relief=FLAT, cursor='hand2', height=200, image=img_manu3, text=f'Meat  {meals.list_MainMeals[0][1]} EGP', compound=TOP,command=select_meat)
m1.pack(side=LEFT, padx=10)
m2 = Button(frame_main_meal, width=200, bg='#022841', font=('Tajawal', 11), fg="white", bd=0, relief=FLAT, cursor='hand2', height=200, image=img_manu4, text=f'Chiken  {meals.list_MainMeals[1][1]} EGP', compound=TOP)
...
m3 = Button(frame_sweet, width=200, bg='#022841', font=('Tajawal', 11), fg="white", bd=0, relief=FLAT, cursor='hand2', height=200, image=img_manu1, text=f'Basbosa   {sweet.list_sweets[0][1]} EGP', compound=TOP)
m3.pack(side=LEFT, padx=10)
m4 = Button(frame_sweet, width=200,bg='#022841', font=('Tajawal', 11), fg="white", bd=0, relief=FLAT, cursor='hand2', height=200, image=img_manu2, text=f'Knafeh   {sweet.list_sweets[1][1]} EGP', compound=TOP)
...
m5 = Button(frame_drink, width=200, bg='#022841', font=('Tajawal', 11), fg="white", bd=0, relief=FLAT, cursor='hand2', height=200, image=img_manu5, text=f'Orange   {drinks.list_Drinks[0][1]} EGP', compound=TOP)
m5.pack(side=LEFT, padx=10)
m6 = Button(frame_drink, width=200, bg='#022841', font=('Tajawal', 11), fg="white", bd=0, relief=FLAT, cursor='hand2', height=200, image=img_manu6, text=f'Mango   {drinks.list_Drinks[1][1]} EGP', compound=TOP)
...
m7 = Button(frame_appetizers, width=200, bg='#022841', font=('Tajawal', 11), fg="white", bd=0, relief=FLAT, cursor='hand2', height=200, image=img_manu7, text=f'Tahini   {drinks.list_Drinks[0][1]} EGP', compound=TOP)
m7.pack(side=LEFT, padx=10)
m6 = Button(frame_appetizers, width=200, bg='#022841', font=('Tajawal', 11), fg="white", bd=0, relief=FLAT, cursor='hand2', height=200, image=img_manu8, text=f'Salad     {drinks.list_Drinks[1][1]} EGP', compound=TOP)
m6.pack(side=LEFT, padx=10)
def enter_name():
...
def seting():
    ...
    def enter():
     ...
     if input_password == str(board.passward):  
        ...
        # إضافة الأزرار إلى الإطار باستخدام grid
